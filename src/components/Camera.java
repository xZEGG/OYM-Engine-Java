...
public class Camera extends Component {
    ...
    @Override
    public void debug(){
        ImGui.text("Component UUID: " + this.getUid());
        ImGui.text("GameObject UUID: " + this.gameObject.getUid());
    }
    ...
    public void update(){
        ...
        if (MouseInput.mouseButtonDown(GLFW.GLFW_MOUSE_BUTTON_RIGHT)) {
            ...
            movePosition(cameraInc.x * moveSpeed, cameraInc.y * moveSpeed, cameraInc.z * moveSpeed);
