...
public class ModelLoader {
    private transient List<Integer> vaos = new ArrayList<>();
    private transient List<Integer> vbos = new ArrayList<>();
    private transient List<Integer> textures = new ArrayList<>();
    ...
    public Mesh loadMesh(float[] vertices, float[] textureCoords, int[] indices) {
        ...
        unbind();
        return new Mesh(vertices, id, indices.length);
    }

    public Mesh loadOBJModel(String fileName) throws Exception {
        ...
        return loadMesh(verticesArr, texCoordArr, indicesArr);
    }
    ...
    public int loadTexture(String filename) {
        ...
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if(buffer == null)
                System.out.println("Image File " + filename + " not loaded " + STBImage.stbi_failure_reason());
